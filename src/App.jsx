      ...
      <section id="contact" className="bg-[#F2F4F6] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            <form className="lg:col-span-2 rounded-2xl bg-white p-6 ring-1 ring-gray-100 grid grid-cols-1 gap-4" onSubmit={(e)=>e.preventDefault()}>
              <div>
                <label htmlFor="name" className="text-sm font-medium text-[#1A2A3A]">Nom & société</label>
                <input id="name" type="text" className="mt-1 w-full rounded-xl border border-gray-300 px-4 py-3 outline-none focus:ring-2 focus:ring-[#4B8DF8]" placeholder="Ex. Marie Dupont – Acme SARL"/>
              </div>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="email" className="text-sm font-medium text-[#1A2A3A]">Email</label>
                  <input id="email" type="email" className="mt-1 w-full rounded-xl border border-gray-300 px-4 py-3 outline-none focus:ring-2 focus:ring-[#4B8DF8]" placeholder="vous@entreprise.fr"/>
                </div>
                <div>
                  <label htmlFor="phone" className="text-sm font-medium text-[#1A2A3A]">Téléphone</label>
                  <input id="phone" type="tel" className="mt-1 w-full rounded-xl border border-gray-300 px-4 py-3 outline-none focus:ring-2 focus:ring-[#4B8DF8]" placeholder="06 00 00 00 00"/>
                </div>
              </div>
              <div>
                <label htmlFor="message" className="text-sm font-medium text-[#1A2A3A]">Votre besoin</label>
                <textarea id="message" rows={5} className="mt-1 w-full rounded-xl border border-gray-300 px-4 py-3 outline-none focus:ring-2 focus:ring-[#4B8DF8]" placeholder="Décrivez votre contexte, vos objectifs et vos contraintes…"/>
              </div>
              <div className="flex items-center justify-between">
                ...
                <button type="submit" className="rounded-xl bg-[#1A2A3A] px-6 py-3 text-white font-semibold hover:opacity-90">Envoyer</button>
              </div>
              <p className="text-xs text-gray-400">En envoyant ce formulaire, vous acceptez notre politique de confidentialité. Aucune donnée n'est partagée à des tiers.</p>
            </form>
          </div>
        </div>
      </section>
