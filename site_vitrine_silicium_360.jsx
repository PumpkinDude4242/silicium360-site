      ...
      <section id="contact" className="bg-[#F2F4F6] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            <form className="lg:col-span-2 rounded-2xl bg-white p-6 ring-1 ring-gray-100 grid grid-cols-1 gap-4">
              <div>
              ...
              <div className="flex items-center justify-between">
                ...
                <button type="button" className="rounded-xl bg-[#1A2A3A] px-6 py-3 text-white font-semibold hover:opacity-90">Envoyer</button>
              </div>
